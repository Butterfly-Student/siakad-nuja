    ...
    <div class="mx-auto max-w-7xl px-5 py-16 sm:px-6 lg:px-8">
        <div class="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="lg:col-span-2">
                <div class="flex items-center gap-3">
                    ...
                    <div class="leading-tight">
                        <div class="text-sm font-black text-white tracking-tight flex items-center gap-1.5">
                            ...
                            <span class="rounded bg-sky-500/20 px-1.5 py-0.5 text-[9px] font-bold text-sky-300 border border-sky-500/30">YANUJA</span>
                        </div>
                        <div class="text-[10px] uppercase tracking-[0.18em] font-semibold text-slate-300">Nurul Jadid · Karduluk Sumenep</div>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    <div class="text-xs text-slate-400 font-semibold mb-1 flex items-center gap-1">
            ...
            <div>
                ...
                <div class="space-y-2.5">
                    <div class="rounded-xl border border-white/5 bg-white/5 p-3">
                        <div class="font-bold text-white text-xs">RA Nurul Jadid</div>
                        <div class="text-[10px] text-slate-400 mt-0.5">NPSN: 69749559 (Raudhatul Athfal)</div>
                    </div>
                    <div class="rounded-xl border border-white/5 bg-white/5 p-3">
                        <div class="font-bold text-white text-xs">MIS Nurul Jadid</div>
                        <div class="text-[10px] text-slate-400 mt-0.5">NPSN: 60720605 (Madrasah Ibtidaiyah)</div>
                    </div>
                    <div class="rounded-xl border border-white/5 bg-white/5 p-3">
                        <div class="font-bold text-white text-xs">MTs Nurul Jadid</div>
                        <div class="text-[10px] text-slate-400 mt-0.5">Madrasah Tsanawiyah (Kelas 7, 8 & 9)</div>
                    </div>
                </div>
            </div>
