{{-- CTA — Dramatic dark closing section --}}
<section class="relative overflow-hidden py-32 sm:py-40">

    {{-- Background --}}
    <div class="absolute inset-0 bg-slate-950 -z-20"></div>
    <div class="absolute inset-0 -z-10">
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[700px] w-[700px] rounded-full bg-brand-700/20 blur-[120px]"></div>
    ...
    <div class="relative mx-auto max-w-4xl px-5 sm:px-6 lg:px-8 text-center">
        ...
        {{-- Floating badge --}}
        <div class="lp-pop inline-flex items-center gap-2 rounded-full border border-brand-500/30 bg-brand-500/10 px-4 py-2 text-xs font-bold tracking-widest text-brand-300 uppercase mb-8">
        ...
        <h2 class="text-5xl font-black leading-[1.05] tracking-tight text-white sm:text-6xl lg:text-7xl">
        ...
        <div class="mt-12 flex flex-col items-center justify-center gap-5 sm:flex-row">
            ...
            <a href="#beranda"
               class="inline-flex items-center gap-2 text-sm font-semibold text-slate-400 hover:text-white transition underline-offset-4 hover:underline">
                ↑ Kembali ke atas
            </a>
        </div>
