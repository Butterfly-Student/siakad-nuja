...
<section id="galeri" class="relative overflow-hidden py-24 sm:py-32">
    ...
    <div class="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div class="lp-reveal mx-auto max-w-2xl text-center mb-16">
            <span class="inline-block rounded-full bg-emerald-500/15 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-emerald-400 mb-5">
                Galeri & Kegiatan
            </span>
            ...
            <p class="mt-5 text-slate-400">Dokumentasi kegiatan santri/siswa Yayasan Nurul Jadid Karduluk Sumenep serta antarmuka SIAKAD modern.</p>
        </div>
        ...
        <div class="mb-16 grid gap-6 sm:grid-cols-3">
            ...
            {{-- Photo 1: KBM Digital --}}
            <div class="lp-reveal group relative overflow-hidden rounded-3xl border border-white/10 bg-slate-900 shadow-2xl transition hover:border-emerald-500/50" style="--lp-delay:0ms">
                ...
                <div class="p-5">
                    <h3 class="font-bold text-white text-base">Pembelajaran Interaktif</h3>
                    <p class="text-xs text-slate-400 mt-1 leading-relaxed">Siswa/Santri berinteraksi dengan kurikulum modern berbasis peranti digital di kelas.</p>
                </div>
            </div>

            {{-- Photo 2: Pramuka / Ekstrakurikuler --}}
            <div class="lp-reveal group relative overflow-hidden rounded-3xl border border-sky-500/20 bg-slate-900 shadow-2xl transition hover:border-sky-500/60" style="--lp-delay:120ms">
                ...
                <div class="p-5">
                    <h3 class="font-bold text-white text-base">Giat Pramuka & Prestasi Juara</h3>
                    <p class="text-xs text-slate-400 mt-1 leading-relaxed">Dokumentasi regu Pramuka Yayasan Nurul Jadid (YANUJA) Karduluk Pragaan Sumenep saat meraih tropi juara.</p>
                </div>
            </div>

            {{-- Photo 3: Tahfidz & Kitab --}}
            <div class="lp-reveal group relative overflow-hidden rounded-3xl border border-white/10 bg-slate-900 shadow-2xl transition hover:border-amber-500/50" style="--lp-delay:240ms">
                <div class="relative h-60 w-full overflow-hidden">
                ...
                <div class="p-5">
                    <h3 class="font-bold text-white text-base">Kajian Al-Qur'an & Kitab Kuning</h3>
                    <p class="text-xs text-slate-400 mt-1 leading-relaxed">Pendalaman ilmu agama Islam berlandaskan ajaran Ahlussunnah wal Jama'ah.</p>
                </div>
            </div>
