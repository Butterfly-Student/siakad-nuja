...
<div class="space-y-6 max-w-5xl">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <h3 class="font-bold text-slate-800">Status Koneksi WhatsApp Gateway</h3>
            </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <a href="{{ route('whatsapp.chatbot-rules') }}" class="bg-white rounded-2xl border border-slate-200 p-5 hover:border-brand-300 hover:shadow-sm transition flex items-center gap-3 group">
            <div class="h-10 w-10 rounded-xl bg-amber-50 text-amber-600 flex items-center justify-center group-hover:bg-amber-100 transition">
            ...
            <div>
                <div class="font-semibold text-slate-800">Rule Chatbot</div>
                <div class="text-xs text-slate-500">Kelola menu & kata kunci</div>
            </div>
        </a>
